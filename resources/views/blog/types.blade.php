            ...
            <div class="case">
                <div class="row">
                    <div class="col-md-6 col-lg-6 col-xl-8 d-flex">
                        <a href="{{ url('blog/'.$type->slug) }}" class="img w-100 mb-3 mb-md-0"
                            style="background-image: url('{{ $type->image }}');"></a>
                    </div>
                        ...
                        <div class="text w-100 pl-md-3">
                            ...
                            <ul class="media-social list-unstyled">
                                ...
                                <li class="ftco-animate"><a href="#"><span class="icon-instagram"></span></a></li>
                                    ...
                                    <div class="meta">
                                        <p class="mb-0"><a
                                                href="#">{{ date('M j, Y', strtotime($type->created_at)) }}</a> | <a
                                                href="#">12 min read</a></p>
                                    </div>
                        </div>
                    </div>
                </div>
